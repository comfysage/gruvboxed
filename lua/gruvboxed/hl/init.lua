...
---@alias gruvboxed.types.ColorSpec { [1]: Color, [2]: Color, link: string, reverse: boolean }
---@alias gruvboxed.types.HLGroups { [string]: gruvboxed.types.ColorSpec }

---@param theme gruvboxed.types.Theme
---@param config gruvboxed.types.Config
function M.setup(theme, config)
  ---@type gruvboxed.types.HLGroups
  local hl_groups = {
    ...
    Cursor = { theme.yellow },
    CursorLine   = { theme.none, theme.bg_accent },
    ...
    LineNr = { theme.bg2 },
    CursorLineNr = { theme.yellow, theme.bg_accent },
  ...
  hl_groups['markdownH1'] = { theme.red }
  hl_groups['markdownH2'] = { theme.yellow }
  ...
  if config.override_terminal then
    require 'gruvboxed.hl.terminal'(theme, theme.colors)
  end
